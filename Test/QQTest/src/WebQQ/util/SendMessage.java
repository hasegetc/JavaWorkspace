...
public class SendMessage {
	...
	public static String sendMsgToFriend(String qq, String msg, String str){
		...
		data = data + qq + ",\"face\":381,\"content\":\"[\\\"" + msg.toString() + "\\\",\\\"\\\\n【提示：此用户正在使用WebQQ：http://web.qq.com/】\\\"," + "[\\\"font\\\",{\\\"name\\\":\\\"宋体\\\",\\\"size\\\":\\\"10\\\",\\\"style\\\":[0,0,0],\\\"color\\\":\\\"000000\\\"}]]\",\"msg_id\":73670001,\"clientid\":\"84636109\",\"psessionid\":\"" + psessionid + "\"}&clientid=84636109" + "&psessionid=" +psessionid;
