...
import WebQQ.util.ExtractGroupInfo;
import WebQQ.util.ExtractUserFromAllFreinds;
import WebQQ.util.HttpClient;
import WebQQ.util.SendMessage;

public class QQ {

	private static String QQNum = "1506214893";
	private static String QQPassword = "yww123321";
