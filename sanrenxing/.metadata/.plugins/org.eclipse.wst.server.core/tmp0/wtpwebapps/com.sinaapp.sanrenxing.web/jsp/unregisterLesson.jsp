...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#js_unregisterSelectBtn').click(function() {
			...
			$('#unregisterForm').ajaxForm({

				success : function() {
					success($('#js_unregisterSelectBtn'));
				}
			}
		...
		$('#js_unregisterAllBtn').click(function() {
			$("#js_unregisterAllBtn").attr("disabled", true);
			$('#js_unregisterAllBtn').removeClass("btn_primary");

			$.ajax({
				type : "get",
				url : "unregister!unregisterAllLesson.action?useid=" + "Test",
				success : function() {
					success($('#js_unregisterAllBtn'));
				}
			})
	...
	<div id="body" class="body">
		<form id="unregisterForm" action="unregister!unregisterLesson.action">
			...
			<div class="tool_bar border with_form">
				<button type="submit" id="js_unregisterSelectBtn"
